        ...
        <nav className="navbar sticky-top bg-white navbar-expand-lg navbar-light py-3">
            <div className="container">
                <Link className="navbar-brand" to="/">
                    <img className="img-fluid" src="" alt="Logo" width="96" />
                </Link>
                ...
                <div className="d-lg-flex">
                 ...
                 7 7 0 0114 0z"
                    ...
                    <Link to="/profile" className="btn ms-3 btn-success d-flex">Profile</Link>
                    <Link to="/logout" className="btn ms-3 btn-danger d-flex">Logout</Link>
                </div>
            </div>
        </nav>
